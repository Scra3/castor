...
const HEADER_COMMENT = ` forest-layout.yml — generated by \`castor layout pull\`.
 Edit this file then run \`castor layout diff\` / \`layout apply\`.
...
export function parseLayoutFile(content: string): {docs: LayoutFileDoc; scope: Partial<LayoutScope>} {
  ...
  if (!header) {
    throw new LayoutFileError('Missing `forest:` header. Generate the file with `castor layout pull`.')
  }
